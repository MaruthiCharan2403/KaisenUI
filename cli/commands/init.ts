...
import { detectFramework, getFrameworkDisplayName, getFrameworkSpecificInstructions } from '../utils/framework-detector.js';
...
`;
  ...
  console.log(chalk.gray('  1. Run') + chalk.white(' kaisenui add <component>') + chalk.gray(' to add components'));
  console.log(chalk.gray('  2. Run') + chalk.white(' kaisenui list') + chalk.gray(' to see all available components\n'));
}
